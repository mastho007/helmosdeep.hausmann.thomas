...
class MiddleEarthReaderTest {
	...
	void should_load_from_a_valid_txt_file() {
		...
		loader.loadFromFile("resources/maps/level-a.txt");
	...
	void should_reject_loading_when_dimensions_are_missing() {
		...
		assertThrows(IllegalStateException.class, () -> loader.loadFromFile("resources/maps/missing-dimensions.txt"));
	}
	...
	void should_reject_loading_when_rows_are_differents() {
		...
		assertThrows(IllegalStateException.class, () -> loader.loadFromFile("resources/maps/unexpected-rows.txt"));
	}
